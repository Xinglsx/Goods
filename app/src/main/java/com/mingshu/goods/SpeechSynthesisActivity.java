...
import com.mingshu.goods.listener.UiMessageListener;
...
public class SpeechSynthesisActivity extends AppCompatActivity {
    ...
    private void speak() {
        ...
        print("合成并播放 按钮已经点击");
        mEditText = (EditText) findViewById(R.id.txtWords);
        int result = mSpeechSynthesizer.speak(mEditText.getText().toString());
        checkResult(result, "speak");
    }
    //  下面是UI部分
    private void initView() {
        findViewById(R.id.btnCreateSpeak).setOnClickListener(new View.OnClickListener() {
            @Override
