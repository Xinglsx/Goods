...
public class UserTypeEditActivity extends ScanBaseActivity {
    ApiCoreManager apiCoreManager;
    ActivityUserTypeEditBinding binding;
    UserInfo user;
    UserInfo curUser;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this,R.layout.activity_user_type_edit);
       ...
       user.setUsertype((short) binding.spinUserType.getSelectedItemPosition());
        ...
        api.invoke(new NetworkEngine.Success<Boolean>(){
            ...
            public void callback(Boolean result){
                ...
                CommonUtil.DisplayToast("用户信息更新成功!",UserTypeEditActivity.this);
                UserTypeEditActivity.this.finish();
            }
            ...
            public void callback(int code,String message,Map rawData){
                PrompUtil.stopProgessDialog();
                CommonUtil.ShowMsg(message,UserTypeEditActivity.this);
            }
