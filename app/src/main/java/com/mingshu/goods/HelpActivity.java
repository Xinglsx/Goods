    ...
    public void onClick(View v) {
        ...
        switch (id) {
            case R.id.linlayout_help1:
                url = "http://www.mingshukeji.com.cn/Help?id=1";
                break;
            case R.id.linlayout_help2:
                url = "http://www.mingshukeji.com.cn/Help?id=2";
                break;
            case R.id.linlayout_help3:
                url = "http://www.mingshukeji.com.cn/Help?id=3";
                break;
            case R.id.linlayout_help4:
                url = "http://www.mingshukeji.com.cn/Help?id=4";
                break;
            case R.id.linlayout_help5:
                url = "http://www.mingshukeji.com.cn/Help?id=5";
                break;
            case R.id.linlayout_help6:
                url = "http://www.mingshukeji.com.cn/Help?id=6";
                break;
            case R.id.linlayout_help7:
                url = "http://www.mingshukeji.com.cn/Help?id=7";
                break;
            case R.id.linlayout_help8:
                url = "http://www.mingshukeji.com.cn/Help?id=8";
                break;
            case R.id.linlayout_help9:
                url = "http://www.mingshukeji.com.cn/Help?id=9";
                break;
            default:
